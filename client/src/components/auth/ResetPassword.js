            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input
                  ...
                  className={`form-control ${(passwordError && (hasSubmitted || touched.password)) ? 'is-invalid' : ''}`}
                  value={password}
            ...
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <input
                  ...
                  className={`form-control ${(confirmPasswordError && (hasSubmitted || touched.confirmPassword)) ? 'is-invalid' : ''} ${confirmPassword && !confirmPasswordError ? 'is-valid' : ''}`}
