...
const OptionsPage = () => {
  ...
  // User menu dropdown logic (copied from SettingsPage)
  ...
  useEffect(() => {
    ...
    if (userMenuRef.current) {
      ...
      if (main) {
        ...
        console.log('[DEBUG] .options-main computed position:', mainStyle.position);
      }
    ...
    <main className="options-main" role="main">
      ...
      <div className="options-inner">
        ...
        <div className="greeting-section">
          <h1 className="options-greeting">Hello, {userName}!</h1>
